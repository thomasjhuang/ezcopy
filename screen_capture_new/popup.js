...
// This event should fire WHEN THE BUTTON IS CLICKED, not when the extension is clicked. Right now, it fires when the extension is clicked.
// It should set the display to block on div#wrap, and display to none on div#button. And do all the other stuff it currently does.
